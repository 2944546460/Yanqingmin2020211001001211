<%@ page import="com.YanQingmin.model.Product" %>
<%@ page import="com.YanQingmin.model.Category" %>
		...
		<div class="table-responsive col-sm-10">
			...
			<c:forEach var="p" items="${productList}">
				...
				<tr>
					...
					<%
						com.YanQingmin.model.Product p=(com.YanQingmin.model.Product)pageContext.findAttribute("p");
