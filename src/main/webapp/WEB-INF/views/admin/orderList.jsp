        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>${o.orderDate}</td>
                    <%
                        com.YanQingmin.model.Order o=(com.YanQingmin.model.Order)pageContext.findAttribute("o");
                        int userId=o.getCustomerId();
                        java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
                        com.YanQingmin.dao.UserDao userDao=new com.YanQingmin.dao.UserDao();
                    ...
                    <td class="cart_total">
                        <%
                            ...
                            String paymentType=com.YanQingmin.model.Payment.findByPaymentId(con,n);
                        %>
